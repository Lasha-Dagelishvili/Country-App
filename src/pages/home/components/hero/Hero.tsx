...
const Hero: React.FC<HeroProps> = ({ lang = 'En' }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    capital: '',
    population: '',
    image: null as File | null, // Image file will be uploaded here
  });
  ...
  const addCountry = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    reader.readAsDataURL(formData.image as Blob); // Convert the image to base64
            ...
            <div className="country-cards-container">
              {state.countries.map((country, index) => (
                <CountryCard
                  ...
                  image={country.image} // Use the base64 image here
                  likes={country.likes}
